	...
	init:function(){
		...
		el.addEventListener('grab-start', function () {
			if (showed === false){
				...
				baseMenu.setAttribute('height', '0.3');
				baseMenu.setAttribute('depth', '0.03');
				baseMenu.setAttribute('width', '0.7');
				baseMenu.setAttribute('material', 'color:black;opacity:0.3');
				document.getElementById('menu').appendChild(baseMenu)
				let baseMenuImg = document.createElement('a-plane');
				baseMenuImg.setAttribute('position',{x:0,y:0,z:0});
				baseMenuImg.setAttribute('height', '0.3');
				baseMenuImg.setAttribute('width', '0.7');
				...
				figure1.setAttribute('position', {x:-0.18,y:-0.6,z:0});
				figure1.setAttribute('width', '0.33');
				figure1.setAttribute('height', '0.33');
				figure1.setAttribute('depth', '0.03');
				figure1.setAttribute('id', 'figure1');
				figure1.setAttribute('material', 'color:white;opacity:0.3');
				document.getElementById('menu').appendChild(figure1);
				let figure11 = document.createElement('a-plane');
				figure11.setAttribute('position', {x:0,y:0,z:0});
				figure11.setAttribute('width', '0.33');
				figure11.setAttribute('height', '0.33');
				...
				figure12.setAttribute('width', '0.08');
				figure12.setAttribute('depth', '0.08');
				figure12.setAttribute('height', '0.08');
				...
				figure2.setAttribute('position', {x:0.18,y:-0.6,z:0});
				figure2.setAttribute('width', '0.33');
				figure2.setAttribute('height', '0.33');
				figure2.setAttribute('depth', '0.03');
				figure2.setAttribute('material', 'color:white;opacity:0.3');
				...
				figure21.setAttribute('position', {x:0,y:0,z:0});
				figure21.setAttribute('width', '0.33');
				figure21.setAttribute('height', '0.33');
				...
				figure22.setAttribute('radius', '0.05');
				figure22.setAttribute('height', '0.09');
				...
				figure3.setAttribute('position', {x:0.18,y:-0.95,z:0});
				figure3.setAttribute('width', '0.33');
				figure3.setAttribute('height', '0.33');
				figure3.setAttribute('depth', '0.03');
				figure3.setAttribute('id', 'figure3');
				figure3.setAttribute('material', 'color:white;opacity:0.3');
				document.getElementById('menu').appendChild(figure3);
				let figure31 = document.createElement('a-plane');
				figure31.setAttribute('position', {x:0,y:0,z:0});
				figure31.setAttribute('width', '0.33');
				figure31.setAttribute('height', '0.33');
				...
				figure32.setAttribute('position', {x:0,y:-0.04,z:0});
				figure32.setAttribute('width', '0.08');
				figure32.setAttribute('height', '0.08');
				...
				figure4.setAttribute('position', {x:-0.18,y:-0.95,z:0});
				figure4.setAttribute('width', '0.33');
				figure4.setAttribute('height', '0.33');
				figure4.setAttribute('depth', '0.03');
				figure4.setAttribute('id', 'figure4');
				figure4.setAttribute('material', 'color:white;opacity:0.3');
				document.getElementById('menu').appendChild(figure4);
				let figure41 = document.createElement('a-plane');
				figure41.setAttribute('position', {x:0,y:0,z:0});
				figure41.setAttribute('width', '0.33');
				figure41.setAttribute('height', '0.33');
